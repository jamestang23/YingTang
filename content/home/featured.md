...
2. Information theory: We develope a [computational framework](https://sites.google.com/view/dmipackage/home) to quantify dynamical mutual information of intracellular signaling process.
 
3. Stochastic process without detailed balance: Stochastic transitions are ubiquitous in nature. Based on [path integral](https://aip.scitation.org/doi/abs/10.1063/1.4890968) approach, we develop a scalable [numerical approach](https://www.nature.com/articles/s41598-017-15889-2) to calculate transition rates for a class of stochastic dynamics. The computational cost is robust with respect to varying noise intensity, beyond small noise limit. The efficient computations on transition rates enable a broader use of stochastic modeling in complex dynamics, such as [cell state transitions](https://www.nature.com/articles/nmeth.4402.pdf?origin=ppub) in developmental process.
